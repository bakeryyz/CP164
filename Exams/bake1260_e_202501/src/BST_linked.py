...
class BST:
    ...
    def _total_height_aux(self, node):
        ...
        if node is None:
            ...
            return node._height + self._total_height_aux(node._left) + self._total_height_aux(node._right)
    ...
    def _shift_left(self, parent):
        ...
        right_child._update_height()
        return right_child
    

    def heavy_right(self):
        """
        ---------------------------------------------------------
        Determines if a tree is weighted to the right side:
        A node is right heavy if:
            it has no children
            if the height of its right child > height of its left child
        Use: hr = source.heavy_right()
        ---------------------------------------------------------
        Returns‌​‌​​​​‌​​‌‌‌‌‌‌‌​​‌‌​‌​‌‌​​:
            True if tree is weighted to the right side, False otherwise.
        ---------------------------------------------------------
        """
        if self._root is None:
            return True
        return self._node_height(self._root._right) > self._node_height(self._root._left)
