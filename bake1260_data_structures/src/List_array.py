...
class List:
    ...
    def find(self, key):
        ...
        return_value = None
        if i > -1:
            return_value = deepcopy(self._values[i])
    ...
    def insert(self, i, value):
        ...
        for j in range(len(self._values) - 1, i, -1):
    ...
    def max(self):
        ...
        max_value = deepcopy(self._values[0])

        for i in range(1, len(self._values)):
            if self._values[i] > max_value:
                max_value = deepcopy(self._values[i])
    ...
    def min(self):
        ...
        min_value = deepcopy(self._values[0])

        for i in range(1, len(self._values)):
            if self._values[i] < min_value:
                min_value = deepcopy(self._values[i])
    ...
    def union(self, source1, source2):
        ...
        -------------------------------------------------------
        """
        self._values = list(set(source1._values) | set(source2._values))
